...
def main():
    ...
    parser.add_argument(
        "--settings",
        help="Settings File",
        default="./examples/animation_settings.json",
        type=str,
    )
    ...
    model_checkpoint =  "v1-5-pruned.ckpt"
    ...
    print(f"Using Settings: {opt.settings}");
    ...
    custom_settings_file = opt.settings
    ...
    def render_image_batch(args):
        ...
        if args.save_settings:
            filename = os.path.join(args.outdir, f"{args.timestring}_settings.json")
    ...
    def render_animation(args, anim_args):
        ...
        # save settings for the batch
        settings_filename = os.path.join(args.outdir, f"{args.timestring}_settings.json")
    ...
    if override_settings_with_file:
        ...
        if not os.path.isfile(custom_settings_file):
            ...
            with open(custom_settings_file, "r") as f:
                ...
                args_dict["outdir"]=get_output_folder(output_path, args_dict["batch_name"])
                anim_args_dict["outdir"]=get_output_folder(output_path, anim_args_dict["batch_name"])
